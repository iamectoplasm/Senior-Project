...
import com.seniorproject.components.Direction.Directions;
...
public class AnimationSystem extends IntervalIteratingSystem
{
	...
	{
		super(Aspect.all(Direction.class,
				Velocity.class,
				MovementState.class,
	...
	protected void updateAnimations(int entityId)
	{
		...
		Directions currentDir = mDirection.get(entityId).currentDirection;
