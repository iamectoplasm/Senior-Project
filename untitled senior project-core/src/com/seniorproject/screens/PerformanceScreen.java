...
public class PerformanceScreen implements Screen
{
	...
	public PerformanceScreen(SeniorProject currentGame)
	{
		...
		//config.setSystem(new RenderSystem(camera, performanceBatch));
	...
	public void render(float delta)
	{
		...
		//map.renderBackground(mapRenderer, mapRenderer.getBatch());
		
		world.setDelta(delta);
		world.process();
		
		//map.renderForeground(mapRenderer, mapRenderer.getBatch());
